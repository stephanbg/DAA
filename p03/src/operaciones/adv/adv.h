 ...
 * @file adv.h
 * @brief Definición de la clase Adv derivada de la clase abstracta Operacion, que se
...
/**
 * @brief Clase Adv derivada de Operacion, se encargará de implementar la suma de los elementos de un registro
 *        y los almacenará en R0
 */
class Adv : public Operacion {
 public:
