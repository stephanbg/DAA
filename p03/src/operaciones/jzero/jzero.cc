 ...
 * @file jzero.cc
 * @brief Implementación de la clase Jzero derivada de la clase abstracta Operacion, que se
 ...
 * 
 * La instrucción "Jzero" salta a la posición de memoria especificada por el operando
 * si R0 == 0.
 * 
