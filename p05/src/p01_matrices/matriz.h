...
class Matriz {
  public:
    Matriz();
    Matriz(const std::vector<std::vector<int>>& kMatriz) : matriz_(kMatriz) {}
    const std::vector<std::vector<int>>& get_matriz() const { return matriz_; }
    std::vector<std::vector<int>>& set_matriz() { return matriz_; }
